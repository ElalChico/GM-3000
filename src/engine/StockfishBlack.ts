...
export class StockfishEngineBlack {
    ...
    this.initPromise = new Promise((resolve) => {
      try {
        ...
        this.worker.onerror = (err) => {
          console.error("Worker error in StockfishBlack:", err);
          resolve();
        };
        ...
        this.worker.onmessage = (e) => {
          ...
          if (typeof msg === 'string') {
            if (msg === 'uciok') {
              ...
              console.log(`[BlackWorker] Received bestmove: ${msg}. isThinking: ${this.isThinkingForMove}, match: ${!!match}`);
              if (match) {
