...
| **Instalador (.EXE 64-bit)** | [Descargar Setup](https://mega.nz/file/aKJVGDJQ#fIi63l1RYg3yvR4DS3A-ubGdl8a1mTXv41u3sBTVspc) | [GitHub Release]([https://github.com/ElalChico/GM-3000/releases/download/v3.1.7/GM-3000+Setup.exe](https://github.com/ElalChico/GM-3000/releases/download/v3.1.7/GM-3000.Setup.exe)) | Instalador tradicional para Windows. Integra accesos directos y configuraciones de sistema. |
